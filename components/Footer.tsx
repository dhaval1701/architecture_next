      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-12 3xl:gap-24 4xl:gap-32 mb-8 sm:mb-10 md:mb-12 lg:mb-16 xl:mb-20 2xl:mb-16 3xl:mb-32 4xl:mb-40">
        ...
        <div className="col-span-1 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center mb-4 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-8 2xl:mb-6 3xl:mb-12 4xl:mb-16">
            <div className="mr-3 sm:mr-4 md:mr-5 lg:mr-6 xl:mr-8 2xl:mr-6 3xl:mr-12 4xl:mr-16">
              <Image
                src="/logos/full_logo_white.svg"
                alt="Logo"
                width={200}
                height={250}
                className="h-16 sm:h-20 md:h-24 lg:h-28 xl:h-32 2xl:h-[66px] 3xl:h-48 4xl:h-56 w-auto"
              />
            </div>
          </div>
        </div>
        ...
        {/* Information Links */}
        <div>
          <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-lg 3xl:text-4xl 4xl:text-5xl font-bold mb-4 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-8 2xl:mb-6 3xl:mb-12 4xl:mb-16">
            Information
          </div>
          <ul className="space-y-1 sm:space-y-1.5 md:space-y-2 lg:space-y-2.5 xl:space-y-3 2xl:space-y-4 3xl:space-y-5 4xl:space-y-6">
            {["Home", "Gallery", "Projects", "About us", "Contacts"].map(
              (item) => (
                <li
                  key={item}
                  className=" text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-[14px] 3xl:text-3xl 4xl:text-4xl hover:text-gray-300 cursor-pointer transition-colors font-bold duration-200"
                >
                  {item}
                </li>
              )
        ...
        <div>
          ...
          <div className="flex gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-7 2xl:gap-5 3xl:gap-10 4xl:gap-12 mb-6 sm:mb-7 md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-10 3xl:mb-20 4xl:mb-24">
            <a
              href="#"
              className="hover:text-gray-300 transition-colors duration-200"
            >
              <Facebook className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-6 2xl:h-6 3xl:w-12 3xl:h-12 4xl:w-16 4xl:h-16" />
            </a>
            <a
              href="#"
              className="hover:text-gray-300 transition-colors duration-200"
            >
              <Instagram className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-6 2xl:h-6 3xl:w-12 3xl:h-12 4xl:w-16 4xl:h-16" />
            </a>
            <a
              href="#"
              className="hover:text-gray-300 transition-colors duration-200"
            >
              <Linkedin className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-6 2xl:h-6 3xl:w-12 3xl:h-12 4xl:w-16 4xl:h-16" />
            </a>
            <a
              href="#"
              className="hover:text-gray-300 transition-colors duration-200"
            >
              <Twitter className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 2xl:w-6 2xl:h-6 3xl:w-12 3xl:h-12 4xl:w-16 4xl:h-16" />
            </a>
          </div>
          <div className="mt-6 sm:mt-7 md:mt-8 lg:mt-10 xl:mt-12 2xl:mt-10 3xl:mt-20 4xl:mt-24">
            <Image
              src="/logos/logo_background.svg"
              alt="Logo"
              width={130}
              height={250}
              className="h-12 sm:h-16 md:h-20 lg:h-24 xl:h-28 2xl:h-38 3xl:h-52 4xl:h-62 w-auto opacity-70"
            />
          </div>
        </div>
      </div>
