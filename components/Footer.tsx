...
const Footer = () => {
  return (
    <footer
      className="text-white px-6 sm:px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-36 3xl:px-42 4xl:px-48
    ...
    >
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:grid md:grid-cols-[1fr_0.6fr_1fr_1fr] md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-12 w-full">
          ...
          <div className="flex gap-6 mb-6 md:contents">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-2.5 sm:space-y-2 lg:space-y-3 xl:space-y-5 3xl:space-y-8 4xl:space-y-10">
          ...
          <div>
            ...
            <Image
              ...
              width={120}
              height={120}
              className="hidden md:block h-10 sm:h-12 md:h-24 lg:h-40 xl:h-52 w-auto opacity-70"
            />
          </div>
        </div>
      </div>
