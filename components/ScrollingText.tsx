...
export default function ScrollingText() {
  const textSet = (
    ...
    >
      {/* THE */}
      <span className="text-gray-300 font-semibold text-[48px] xs:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[104px] xl:text-[120px] 2xl:text-[204px] 3xl:text-[300px] 4xl:text-[400px]">
        THE
      </span>
      ...
      <div className="relative flex items-start ml-1.5 sm:ml-2 md:ml-3 lg:ml-5 xl:ml-6 2xl:ml-8 3xl:ml-10 4xl:ml-14">
        <span className="font-semibold text-red-900 leading-none text-[48px] xs:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[104px] xl:text-[120px] 2xl:text-[204px] 3xl:text-[300px] 4xl:text-[400px]">
          23
        </span>
      ...
      {/* STUDIO */}
      <span className="font-semibold text-gray-300 ml-4 sm:ml-6 md:ml-8 lg:ml-16 xl:ml-20 2xl:ml-28 3xl:ml-36 4xl:ml-44 text-[48px] xs:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[110px] xl:text-[130px] 2xl:text-[170px] 3xl:text-[210px] 4xl:text-[400px]">
        studio
      </span>
    </div>
  );
