...
export default function ScrollingText() {
  const textSet = (
    ...
    >
      {/* THE */}
      <span className="text-gray-300 font-semibold text-[38px] xs:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[104px] xl:text-[120px] 2xl:text-[204px] 3xl:text-[300px] 4xl:text-[400px]">
        THE
      </span>
      ...
      <div className="relative flex items-start ml-1.5 sm:ml-2 md:ml-3 lg:ml-5 xl:ml-6 2xl:ml-8 3xl:ml-10 4xl:ml-14">
        <span className="font-semibold text-red-900 leading-none text-[38px] xs:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[104px] xl:text-[120px] 2xl:text-[204px] 3xl:text-[300px] 4xl:text-[400px]">
          23
        </span>
