    ...
    <div className="">
      ...
      <div className="grid breakout lg:grid-cols-2 gap-6 lg:gap-2 3xl:gap-4 4xl:gap-6 5xl:gap-8 items-stretch mb-12 sm:mb-16 md:mb-20 lg:mb-24 xl:mb-28 3xl:mb-36 4xl:mb-44 5xl:mb-52">
        ...
        <div className="order-1 lg:order-1 h-full">
          <div className="relative h-full aspect-[9/11] w-full overflow-hidden">
            <Image
        ...
        <div className="p-5 md:pd-0 order-2 lg:order-2 flex flex-col h-full justify-start 2xl:pr-34 3xl:pr-24 4xl:pr-32 5xl:pr-40">
          {/* Heading */}
          <div className="flex flex-wrap items-baseline gap-3 sm:gap-4 lg:gap-6 3xl:gap-8 4xl:gap-10 5xl:gap-12">
            <p className="text-4xl sm:text-5xl md:text-6xl 2xl:text-7xl 3xl:text-[7rem] 4xl:text-[9rem] 5xl:text-[12rem] font-light text-[#BDBDBD] tracking-wider">
              About
            </p>
            <p className="text-4xl sm:text-5xl md:text-6xl 2xl:text-7xl 3xl:text-[7rem] 4xl:text-[9rem] 5xl:text-[12rem] font-light text-black tracking-tight">
              23
          ...
          {/* Paragraphs */}
          <div className="mt-6 sm:mt-8 lg:mt-10 xl:mt-12 3xl:mt-16 4xl:mt-20 5xl:mt-24 space-y-4 sm:space-y-6 lg:space-y-8 xl:space-y-10 3xl:space-y-12 4xl:space-y-14 5xl:space-y-16 text-sm sm:text-base md:text-lg lg:text-[16px] 3xl:text-[28px] 4xl:text-[34px] 5xl:text-[54px] text-black font-light leading-[20px] md:leading-[26px] 3xl:leading-[36px] 4xl:leading-[44px] 5xl:leading-[56px]">
            <p>
      ...
      <div className="">
        ...
        <div className="mb-4 sm:mb-6 md:mb-8 lg:mb-12 xl:mb-14 3xl:mb-22 4xl:mb-32 5xl:mb-40">
          <p className="text-[#BDBDBD] text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl 3xl:text-[7rem] 4xl:text-[9rem] 5xl:text-[12rem] font-light mb-2 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-6 3xl:mb-8 4xl:mb-10 5xl:mb-12 leading-none">
            Founder&apos;s{" "}
            <span className="text-[#333333] text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl 3xl:text-[7rem] 4xl:text-[9rem] 5xl:text-[12rem] font-light leading-tight">
              Vision
            </span>
          </p>
        </div>
