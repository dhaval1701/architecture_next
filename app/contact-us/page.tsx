              ...
              <form className="space-y-3 lg:space-y-4 xl:space-y-5">
                ...
                <div>
                  <textarea
                    rows={3}
                    placeholder="Message"
                    className="w-full px-3 lg:px-4 py-2 lg:py-2.5 border border-gray-300 bg-white/90 text-gray-700 placeholder-gray-500 focus:border-gray-500 focus:outline-none resize-none transition-colors rounded-none text-sm lg:text-base"
                  ></textarea>
                </div>
